...
namespace BYUEgyptExcavation.Models
{
    public partial class Burial
    {
       ...
       public int MummyId { get; set; }
        ...
        //{
        //    return this.BurialId = ($"{this.BurialLocationNs} {this.LowPairNs}/{this.HighPairNs} {this.BurialLocationEw} {this.LowPairEw}/{this.HighPairEw} {this.BurialSubplot} #{this.BurialNumber}");
        //}
